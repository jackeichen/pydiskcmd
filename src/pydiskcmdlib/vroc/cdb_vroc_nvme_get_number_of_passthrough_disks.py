...
class GetNumberOfPassthroughDisks(VROCNVMeCommand):
    _cdb_bits = {"HeaderLength": [0xFFFFFFFF, 0],  
                 ...
                 "numberOfPassthroughDisks": [0xFFFFFFFF, 28], # output
                }
    def __init__(self,):
        VROCNVMeCommand.__init__(self)
        self.build_command(Signature=win_ioctl.NVME_RAID_SIG_STR,
                           ControlCode=win_ioctl.NVME_GET_NUMBER_OF_PASSTHROUGH_DISKS,
                           )
