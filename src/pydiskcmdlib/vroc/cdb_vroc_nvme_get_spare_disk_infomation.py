...
class GetSpareDiskInformation(VROCNVMeCommand):
    ...
    def __init__(self, number_of_spare_disks):
        VROCNVMeCommand.__init__(self)
        self.build_command(Signature=win_ioctl.NVME_RAID_SIG_STR,
                           ControlCode=win_ioctl.NVME_GET_SPARE_DISKS_INFORMATION,
                           ReturnBufferLen=number_of_spare_disks*win_ioctl.sizeof(win_ioctl.NVME_MEMBER_DISK_INFORMATION),
                           )
