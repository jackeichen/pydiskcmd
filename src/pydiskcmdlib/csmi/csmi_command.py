...
class CSMICommandPro(CommandWrapperPro):
    '''
    This Class define the function that must be implemented by CommandWrapperPro function.
    ...
    def __init__(self, cdb_raw_struc):
        ...
        if os_type != "Windows":
            raise NotImplementedError("%s Do Not Support this command" % os_type)
        CommandWrapperPro.__init__(self, cdb_raw_struc, bytes_aligned=4)  # should be DW aligned
