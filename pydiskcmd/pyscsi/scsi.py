...
from pydiskcmd.pyscsi.scsi_cdb_exchangemedium import ExchangeMedium
from pydiskcmd.pyscsi.scsi_cdb_getlbastatus import GetLBAStatus
from pydiskcmd.pyscsi.scsi_cdb_initelementstatus import InitializeElementStatus
from pydiskcmd.pyscsi.scsi_cdb_initelementstatuswithrange import (
    InitializeElementStatusWithRange,
)
from pydiskcmd.pyscsi.scsi_cdb_inquiry import Inquiry
from pydiskcmd.pyscsi.scsi_cdb_modesense6 import ModeSelect6, ModeSense6
from pydiskcmd.pyscsi.scsi_cdb_modesense10 import ModeSelect10, ModeSense10
from pydiskcmd.pyscsi.scsi_cdb_movemedium import MoveMedium
from pydiskcmd.pyscsi.scsi_cdb_openclose_exportimport_element import (
...
from pydiskcmd.pyscsi.scsi_cdb_positiontoelement import PositionToElement
from pydiskcmd.pyscsi.scsi_cdb_preventallow_mediumremoval import PreventAllowMediumRemoval
from pydiskcmd.pyscsi.scsi_cdb_read10 import Read10
from pydiskcmd.pyscsi.scsi_cdb_read12 import Read12
from pydiskcmd.pyscsi.scsi_cdb_read16 import Read16
from pydiskcmd.pyscsi.scsi_cdb_readcapacity10 import ReadCapacity10
from pydiskcmd.pyscsi.scsi_cdb_readcapacity16 import ReadCapacity16
from pydiskcmd.pyscsi.scsi_cdb_readelementstatus import ReadElementStatus
from pydiskcmd.pyscsi.scsi_cdb_report_luns import ReportLuns
from pydiskcmd.pyscsi.scsi_cdb_report_priority import ReportPriority
from pydiskcmd.pyscsi.scsi_cdb_testunitready import TestUnitReady
from pydiskcmd.pyscsi.scsi_cdb_write10 import Write10
from pydiskcmd.pyscsi.scsi_cdb_write12 import Write12
from pydiskcmd.pyscsi.scsi_cdb_write16 import Write16
from pydiskcmd.pyscsi.scsi_cdb_writesame10 import WriteSame10
from pydiskcmd.pyscsi.scsi_cdb_writesame16 import WriteSame16
...
class SCSI(object):
    ...
    def passthrough16(self, 
                    ...
                    **kwargs):
        """
        Return a PassThrough16 Instance
    ...
    def passthrough12(self, 
                    ...
                    **kwargs):
        """
        Return a PassThrough12 Instance
        ...
        :return: a PassThrough instance
        """
        opcode = self.device.opcodes.PASS_THROUGH_12
        cmd = PassThrough12(opcode,
                          self.blocksize,
                          lba,
                          protocal,
                          t_lenght,
